...
function initGsap() {
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.circle__items--3', {
    scrollTrigger: {
      trigger: '.skills',
      start: '-80%',
      end: '100%',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.circle__item--row-3', {
    scrollTrigger: {
      trigger: '.skills',
      start: '-80%',
      end: '100%',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.circle__items--2', {
    scrollTrigger: {
      trigger: '.skills',
      start: '-80%',
      end: '100%',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.circle__item--row-2', {
    scrollTrigger: {
      trigger: '.skills',
      start: '-80%',
      end: '100%',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.circle__items--1', {
    scrollTrigger: {
      trigger: '.skills',
      start: '-80%',
      end: '100%',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.circle__item--row-1', {
    scrollTrigger: {
      trigger: '.skills',
      start: '-80%',
      end: '100%',
